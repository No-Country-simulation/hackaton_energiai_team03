 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "        recoms.append('Reduzir abertura de freezers de exibição entre 18h e 21h, horário de tarifa elevada.')\n",
    "    if d['estacao_ano'] in ('Inverno', 'Outono'):\n",
    "        recoms.append('Consolidar estoque em menos freezers durante o período de menor movimento (outono/inverno).')\n",
    "    if d['estado_borracha'] == 'Gasta':\n",
    "        recoms.append(f'Agendar manutenção das borrachas de vedação dos freezers de {d[\"tipo_predominante\"]}.')\n",
    "    if d['tecnologia_predominante'] == 'Convencional':\n",
    "        recoms.append('Avaliar substituição de equipamentos convencionais por modelos com tecnologia Inverter.')\n",
    "    if not recoms:\n",
    ...
    "            'custoEstimadoMensal': custo_atual,\n",
  ...
  },
  {
   ...
   "source": [
    "---\n",
    "**Notebook concluído.** O modelo está treinado, avaliado e serializado para integração com o backend.\n",
    "\n",
...
print('Notebook reconstruído com sucesso!')
